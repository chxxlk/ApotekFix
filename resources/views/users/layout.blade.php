        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto me-3">
                    @if (session()->has('id') || Cookie::has('user_login'))
                    @auth
                    <div class="btn-group">
                        <a href="{{route('users.profile')}}" class="btn btn-secondary">{{ session()->get('name') }}</a>
                        <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="visually-hidden">Toggle Dropdown</span>
                        </button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('users.profile') }}">Akun</a></li>
                            <li><a class="dropdown-item" href="{{route('user.keranjang.show')}}">Keranjang</a></li>
                            <li><a class="dropdown-item" href="{{route('users.riwayatPembelian')}}">Riwayat Belanja</a></li>
                            <li>
                ...
                <form action="{{ route('users.dashboard') }}" method="GET" class="d-flex">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="\images\corausel_3.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block text-start">
                    <h2>Ayo Bergabung Bersama Kami</h2>
                    <p class="fs-5">Untuk hidup sehat, gunakan obat yang tepat</p>
                    <a class="btn btn-primary" href="{{ route('register') }}">Daftar</a>
                </div>
            </div>
            <div class="carousel-item">
                <img src="\images\corausel_2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block text-center">
                    <h2 class="text-black">Pelayanan Kesehatan Terbaik</h2>
                    <p class="fs-5 text-black">Dapatkan obat-obatan dan produk kesehatan terlengkap hanya di apotek kami.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="\images\corausel_1.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block text-end">
                    <h2>Login untuk Melihat Lebih Banyak</h2>
                    <p class="fs-5">Silakan login untuk mengakses lebih banyak fitur dan informasi.</p>
    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col-md-4 d-flex align-items-center">
                ...
                <span class="mb-3 mb-md-0 text-body-secondary">&copy; 2024 Apotik, Inc</span>
            </div>
